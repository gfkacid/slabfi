      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="space-y-8">
          <header className="space-y-2">
            ...
            <p className="max-w-2xl text-sm text-on-surface/70 md:text-base">
              Icons are global (loaded once in <code className="font-mono">main.tsx</code>), inherit
              current text color, and can be resized with Tailwind <code className="font-mono">text-*</code>{" "}
              utilities.
            </p>
          </header>
          ...
          <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {ICONS.map((icon) => (
              <div
                key={icon.className}
                className="flex items-center gap-4 rounded-2xl border border-outline-variant/15 bg-surface px-5 py-4 shadow-sm"
              >
                ...
                <div className="flex flex-col">
                  ...
                  <div className="text-xs text-on-surface/60">
                    <code className="font-mono">bi {icon.className}</code>
                  </div>
                </div>
              </div>
            ))}
          ...
          <section className="rounded-2xl border border-outline-variant/15 bg-surface px-6 py-5 shadow-sm">
            <div className="text-sm font-semibold">Sizing + color inheritance</div>
            <div className="mt-3 flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-3">
                <span className="text-xs text-on-surface/60">Small</span>
              ...
              <div className="flex items-center gap-3 text-secondary">
                <span className="text-xs text-on-surface/60">Inherits color</span>
